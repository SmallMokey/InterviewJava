...
public class Java03_02_DuplicationInArrayNoEdit {
    ...
    public void findduplication() throws Exception {
        ...
        assertEquals(2, Java03_02_DuplicationInArrayNoEdit.findduplication(ints1));
        ints1 = new int[]{2, 3, 4, 5, 1, 1, 2, 1};
        List<Integer> list = Arrays.asList(2, 1);
        assertEquals(list.contains(Java03_02_DuplicationInArrayNoEdit.findduplication(ints1)), true);
    }
