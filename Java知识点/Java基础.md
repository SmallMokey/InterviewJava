...
![Java异常类层次结构图 ](assets/Java%E5%BC%82%E5%B8%B8%E7%B1%BB%E5%B1%82%E6%AC%A1%E7%BB%93%E6%9E%84%E5%9B%BE.png)
...
**concurrentHashMap的优化从1.7到1.8**  
参考链接：https://blog.csdn.net/varyall/article/details/81277168
...
1. jdk 1.7  
   ...
   - 自动资源管理，java中Connections，Files，Input/OutputStreams等，需要我们手动关闭，现在可自动管理
...
2. jdk 1.8
   ...
   - HashMap的底层实现有变化  
     引入红黑树优化HashMap
   - Jvm内存管理方面，有元空间代替了永久代  
     区别：  
     1. 元空间不在虚拟机中，而是在本地内存中
     2. 默认情况下，元空间大小受本地内存大小限制
